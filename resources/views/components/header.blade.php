...
<ul class="user-login">
<li>
<a href="{{ route('weblogin') }}">Sign In</a>
</li>
<li>
<a href="{{ route('webregister') }}">Register</a>
</li>
</ul>
</div>
</div>
...
<ul class="shop " id="All_item">
@forelse ($cart as $cart_list)

<li class="cart_item">
<a href="javascript:void(0)" class="remove delete_item" title="Remove this item" id_pro="{{  $cart_list["products"][0]["id"] }}">
    <i class="lni lni-close"></i></a>
<div class="cart-img-head">
<a class="cart-img" href="product-details.html"><img src="{{  asset("storage/images/".$cart_list["products"][0]["images"][0]["file"]) }}" alt="#"></a>
</div>
<div class="content">
<h4><a href="product-details.html">{{ $cart_list["products"][0]["name"] }}</a></h4>
<p class="quantity">
    <span class="amount count_item">{{ $cart_list->count }}</span>
    x -
     <span class="amount price_item">{{ $cart_list['products'][0]["price"] }}</span>
    </p>
</div>
</li>
@empty
