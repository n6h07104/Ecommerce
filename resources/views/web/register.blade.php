...
if(isset($_GET["message"])):
  $er=$_GET["message"];
?>
<div class="alert alert-success" role="alert"><?php echo $er?></div>
<?php endif ?>
<form class="row" method="post" action="{{route('webdata')}}">
    @csrf
<div class="col-sm-6">
...
<p class="outer-link">Already have an account? <a href="{{ route('weblogin') }}">Login Now</a>
</p>
</form>
</div>
</div>
