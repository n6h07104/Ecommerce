...
<div class="row">
    ...
    <img src="{{asset('storage/images/'.$val['images'][0]['file'])}}" alt="#">
    <div class="button">
        @if (Auth::guard('web')->check())
        <bottom class="btn add_to_cart" id_pro="{{ $val->id }}"><i class="lni lni-cart"></i> Add to Cart</bottom>
        @else
        <a href="{{ route('weblogin') }}" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
        @endif
    </div>
    </div>
